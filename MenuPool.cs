...
namespace INMNativeUI
{
    ...
    public class MenuPool
    {
        ...
        /// <summary>
        /// Update all of your menus' stats. Call this in a tick event.
        /// </summary>
        public void UpdateStats(int Stat1, int Stat2, int Stat3, int Stat4)
        {
            foreach (UIMenu item in from menu in _menuList where menu.EnableStats select menu)
            {
                item.Stat1 = Stat1;
                item.Stat2 = Stat2;
                item.Stat3 = Stat3;
